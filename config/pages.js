...
content = [
  ...
  },
  {
    ...
    "bottom_text": "<p>Data portability reduces people’s dependence on particular services. It means people can think about their habits online in a different way, and change them at their convenience. It’s the kind of thing that will stimulate innovation in the market.</p>",
  ...
  },
  {
    ...
    "top_text": "<p>When we see adverts online it’s usually clear they have some relationship to our browsing history. But that connection is rarely explicit.</p><p>By revealing why we’ve been targeted by a particular ad we can learn more about what companies know about us, and opt out when that doesn’t feel right.</p>",
    "bottom_text": "<p>While the cookie law attempted to protect consumers from data harvesting, cookie banners have just made the issue more obscure.</p><p>Transparent targeting exposes the information advertisers have to people straight away. It puts them in control of whether that data should be used or not, and gives them the ability to make that update quickly.</p>",
  ...
  },
  {
    ...
    "bottom_text": "<p>At the moment, if a service has your address it can be very difficult to change it, let alone change the address held by everyone they sold your address to. That makes it hard to imagine having much say in what happens to your data after you die.</p><p>The General Data Protection Regulation makes it clear that you do have the right to rectify your data. Companies need to model that in ways that allow for much more extreme changes of circumstance.</p>",
